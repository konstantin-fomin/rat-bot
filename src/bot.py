...
ROAST_PROMPT_TEMPLATE = (
    ...
    "Не обвешивай кандидатов кавычками с дословными вставками из сообщений — вместо этого перескажи "
    "характерную деталь своими словами, естественно вплетя её в шутку. Кавычки уместны максимум "
    "один раз в каждом кандидате, если это действительно важно процитировать дословно. "
